...
object UsersData {
    private val userUserNames = arrayOf(
        "JakeWharton",
        "amitshekhariitbhu",
        "romainguy",
        "chrisbanes",
    ...
    private val userLocations = arrayOf(
        "Pittsburgh, PA, USA",
        "New Delhi, India",
        "California",
        "Sydney, Australia",
    ...
    private val userRepositories = arrayOf(
        "102",
        "37",
        "9",
        "30",
    ...
    private val userCompanies = arrayOf(
        "Google, Inc.",
        "MindOrksOpenSource",
        "Google",
    ...
    private val userFollowings = arrayOf(
        "12",
        "2",
        "0",
        "1",
